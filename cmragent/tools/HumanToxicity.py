...
class HumanToxicityTool(BaseTool):
    name: str = "HumanToxicityTool"
    description: str = (
        "Input chemical name, CAS number, or SMILES notation, returns a summary of human toxicity information. "
        "The summary includes human toxicity excerpts, human toxicity values, toxicity summary, toxicity data, and toxicological information."
    )
    ...
    def __init__(self, llm: BaseLLM):
        super().__init__()
        self.llm = llm
        self.properties = ["Human Toxicity"]
    ...
    def get_human_toxicity_summary(self, identifier: str) -> str:
        all_data = []
        ...
        if not all_data:
            return "No human toxicity data found."
    ...
    def _run(self, input_str: str) -> str:
        try:
            summary = self.get_human_toxicity_summary(input_str)
            return summary
        except Exception as e:
    ...
    def _arun(self, query: str) -> str:
        ...
        raise NotImplementedError("HumanToxicityTool does not support async")